...
> ⛔️ De import wordt nu geblokkeerd. HelloID ziet dat er een persoon ontbreekt en grijpt in — precies wat je met de threshold wilde bereiken. De geblokkeerde import mag je handmatig goedkeuren via de overzichtspagina van je bronsystemen.
